...
urlpatterns = [
    ...
    path('staff_calendar', StaffViews.staff_calendar, name="staff_calendar"),
    ...
    path('student_calendar', StudentViews.student_calendar, name="student_calendar"),
    ...
    path('student_course',StudentViews.student_course,name="student_course"),
